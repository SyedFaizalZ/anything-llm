...
const { doomAgentEndpoints } = require("./endpoints/doomAgent");
const { canvasEndpoints } = require("./endpoints/canvas");
...
doomAgentEndpoints(apiRouter);
canvasEndpoints(apiRouter);
